...
void main() {
  ...
  group('CodeFindController method ', () {
    test('`findMode`', () async {
      ...
      }
      {
        ...
        expect(
          controller.findInputController.selection,
    ...
    test('`focusOnReplaceInput`', () {
      ...
      expect(
        controller.replaceInputController.selection,
        const TextSelection(baseOffset: 0, extentOffset: 3),
      );
    });
  ...
  group('CodeEditor ', () {
    testWidgets(
      'ignores notifications from a previous findController after swap',
      (tester) async {
        final CodeLineEditingController editingController =
            CodeLineEditingController.fromText('abc');
        final CodeFindController oldFindController = CodeFindController(
          editingController,
        );
        final CodeFindController newFindController = CodeFindController(
          editingController,
        );
        int buildCount = 0;
    ...
    testWidgets(
      'ignores stale findController notifications after the editor is removed',
      (tester) async {
        final CodeLineEditingController editingController =
            CodeLineEditingController.fromText('abc');
        final CodeFindController oldFindController = CodeFindController(
